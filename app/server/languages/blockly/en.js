...
/** @export */ Blockly.Msg.LISTS_CREATE_WITH_TOOLTIP = "Create a list with any number of items. the length of list is 100.";
...
/** @export */ Blockly.Msg.MATH_CHANGE_TOOLTIP = "Add a number to variable '%1'. Support only data type number.";
...
/** @export */ Blockly.Msg.MATH_MIN_MAX_TOOLTIP = "Return min or max number";
/** @export */ Blockly.Msg.MATH_MIN = "min";
/** @export */ Blockly.Msg.MATH_MAX = "max";
/** @export */ Blockly.Msg.MATH_CONVERT_RA_DE = "radians to degrees";
/** @export */ Blockly.Msg.MATH_CONVERT_DE_RA = "degrees to radians";
/** @export */ Blockly.Msg.MATH_CONVERT_RA_DE_TOOLTIP="Convert between radians and degrees.";
/** @export */ Blockly.Msg.MATH_CONVERT_RA_DE_TITLE="Convert";
/** @export */ Blockly.Msg.MATH_FLOOR="floor";
/** @export */ Blockly.Msg.MATH_CEILING="ceiling";
/** @export */ Blockly.Msg.MATH_FLOOR_CEILING_TOOLTIP="Return floor or ceiling number.";
...
/** @export */ Blockly.Msg.VARIABLES_SET_TOOLTIP = "Sets this variable to be equal to the input. Support only data type number.";
...
/** @export */ Blockly.Msg.BASIC_HUE = "#5BA58C";
/** @export */ Blockly.Msg.MATH_HUE = "#3A4F8B";
/** @export */ Blockly.Msg.LOGIC_HUE = "#617E95";
/** @export */ Blockly.Msg.LOOPS_HUE = "#56A668";
/** @export */ Blockly.Msg.WAIT_HUE = "#759D61";
/** @export */ Blockly.Msg.MUSIC_HUE = "#A15873";
/** @export */ Blockly.Msg.SENSOR_HUE = "#9DA169";
/** @export */ Blockly.Msg.RTC_HUE = "#B9926C";
/** @export */ Blockly.Msg.IO_HUE = "#9E6E5E";
/** @export */ Blockly.Msg.ADVANCE_HUE = "#92568E";
/** @export */ Blockly.Msg.GAUGE_HUE = "#93A01E";
/** @export */ Blockly.Msg.FEED_HUE = "#93A01E";
...
// basic blocks
// led16x8
/** @export */ Blockly.Msg.BASIC_LED16X8_TITLE = "LED 16x8";
/** @export */ Blockly.Msg.BASIC_LED16X8_TOOLTIP = "Display selected dot on LED 16x8";
/** @export */ Blockly.Msg.BASIC_LED16X8_HELPURL = "";
// led16x8 clear
/** @export */ Blockly.Msg.BASIC_LED16X8_CLR_TITLE = "Clear LED 16x8";
/** @export */ Blockly.Msg.BASIC_LED16X8_CLR_TOOLTIP = "Clear LED 16x8 display";
/** @export */ Blockly.Msg.BASIC_LED16X8_CLR_HELPURL = "";
// led16x8 2chars
/** @export */ Blockly.Msg.BASIC_LED16X8_2CHARS_TITLE = "LED 16x8 2-chars";
/** @export */ Blockly.Msg.BASIC_LED16X8_2CHARS_TOOLTIP = "Display 2 characters on LED 16x8";
/** @export */ Blockly.Msg.BASIC_LED16X8_2CHARS_HELPURL = "";
// led scroll
/** @export */ Blockly.Msg.BASIC_LED16X8_SCROLL_TITLE = "LED 16x8 Scroll";
/** @export */ Blockly.Msg.BASIC_LED16X8_SCROLL_TOOLTIP = "Display scrolling string on LED 16x8";
/** @export */ Blockly.Msg.BASIC_LED16X8_SCROLL_HELPURL = "";
// led scroll when ready
/** @export */ Blockly.Msg.BASIC_LED16X8_SCROLL_WHEN_READY_TITLE = "LED 16x8 Scroll When Ready";
/** @export */ Blockly.Msg.BASIC_LED16X8_SCROLL_WHEN_READY_TOOLTIP = "Display scrolling string on LED 16x8 when ready (last scrolling finished)";
/** @export */ Blockly.Msg.BASIC_LED16X8_SCROLL_WHEN_READY_HELPURL = "";
// delay
/** @export */ Blockly.Msg.BASIC_DELAY_TITLE = "Delay";
/** @export */ Blockly.Msg.BASIC_DELAY_UNIT = "s";
/** @export */ Blockly.Msg.BASIC_DELAY_TOOLTIP = "Delay for a seconds";
/** @export */ Blockly.Msg.BASIC_DELAY_HELPURL = "";
// forever
/** @export */ Blockly.Msg.BASIC_FOREVER_TITLE = "Forever";
/** @export */ Blockly.Msg.BASIC_FOREVER_TOOLTIP = "Forver loop";
/** @export */ Blockly.Msg.BASIC_FOREVER_HELPURL = "";
// string
/** @export */ Blockly.Msg.BASIC_STRING_TOOLTIP = "A constant string (maximum 31 characters)";
/** @export */ Blockly.Msg.BASIC_STRING_HELPURL = "";

// math blocks
// number
/** @export */ Blockly.Msg.MATH_NUMBER_TOOLTIP = "A constant number";
/** @export */ Blockly.Msg.MATH_NUMBER_HELPURL = "";
// arithmetic
/** @export */ Blockly.Msg.MATH_MODULO_SYMBOL = "%";
/** @export */ Blockly.Msg.MATH_ARITHMETIC_TOOLTIP = "Math arithmetic";
/** @export */ Blockly.Msg.MATH_ARITHMETIC_HELPURL = "";
// variable
/** @export */ Blockly.Msg.MATH_VARIABLE_TITLE = "Variable";
/** @export */ Blockly.Msg.MATH_VARIABLE_TOOLTIP = "Define variable";
/** @export */ Blockly.Msg.MATH_VARIABLE_HELPURL = "";
/** @export */ Blockly.Msg.VARIABLES_SET_SET = "set";
/** @export */ Blockly.Msg.VARIABLES_SET_TO = "to";

// logic blocks
/** @export */ Blockly.Msg.LOGIC_IF_THEN_ELSE_TITLE = "if";
/** @export */ Blockly.Msg.LOGIC_IF_THEN_ELSE_TOOLTIP = "If a value is true, then do the first block of statements. Otherwise, do the second block of statements.";
/** @export */ Blockly.Msg.LOGIC_IF_THEN_ELSE_HELPURL = "";
// led 16x8 scroll ready
/** @export */ Blockly.Msg.LOGIC_LED16X8_SCROLL_READY_TITLE = "LED matrix ready to scroll";
/** @export */ Blockly.Msg.LOGIC_LED16X8_SCROLL_READY_TOOLTIP = "Return true if LED matrix is ready to scroll (last scrolling finished)";
/** @export */ Blockly.Msg.LOGIC_LED16X8_SCROLL_READY_HELPURL = "";
// sw1 pressed
/** @export */ Blockly.Msg.LOGIC_SW1_PRESSED_TITLE = "Switch 1 pressed";
/** @export */ Blockly.Msg.LOGIC_SW1_PRESSED_TOOLTIP = "Return true if Switch 1 is pressed";
/** @export */ Blockly.Msg.LOGIC_SW1_PRESSED_HELPURL = "";
// sw1 released
/** @export */ Blockly.Msg.LOGIC_SW1_RELEASED_TITLE = "Switch 1 released";
/** @export */ Blockly.Msg.LOGIC_SW1_RELEASED_TOOLTIP = "Return true if Switch 1 is released";
/** @export */ Blockly.Msg.LOGIC_SW1_RELEASED_HELPURL = "";
// sw2 pressed
/** @export */ Blockly.Msg.LOGIC_SW2_PRESSED_TITLE = "Switch 2 pressed";
/** @export */ Blockly.Msg.LOGIC_SW2_PRESSED_TOOLTIP = "Return true if Switch 2 is pressed";
/** @export */ Blockly.Msg.LOGIC_SW2_PRESSED_HELPURL = "";
// sw2 released
/** @export */ Blockly.Msg.LOGIC_SW2_RELEASED_TITLE = "Switch 2 released";
/** @export */ Blockly.Msg.LOGIC_SW2_RELEASED_TOOLTIP = "Return true if Switch 2 is released";
/** @export */ Blockly.Msg.LOGIC_SW2_RELEASED_HELPURL = "";

// loop blocks
// break
/** @export */ Blockly.Msg.LOOP_BREAK_TITLE = "Break";
/** @export */ Blockly.Msg.LOOP_BREAK_TOOLTIP = "Break current loop";
/** @export */ Blockly.Msg.LOOP_BREAK_HELPURL = "";
// continue
/** @export */ Blockly.Msg.LOOP_CONTINUE_TITLE = "Continue";
/** @export */ Blockly.Msg.LOOP_CONTINUE_TOOLTIP = "Continue current loop";
/** @export */ Blockly.Msg.LOOP_CONTINUE_HELPURL = "";

// wait blocks
// wait led matrix ready
/** @export */ Blockly.Msg.WAIT_LED_MATRIX_READY_TITLE = "Wait LED matrix ready";
/** @export */ Blockly.Msg.WAIT_LED_MATRIX_READY_TOOLTIP = "Wait LED matrix ready to display (last scrolling finished)";
/** @export */ Blockly.Msg.WAIT_LED_MATRIX_READY_HELPURL = "";
// wait sw1 pressed
/** @export */ Blockly.Msg.WAIT_SW1_PRESSED_TITLE = "Wait Switch 1 pressed";
/** @export */ Blockly.Msg.WAIT_SW1_PRESSED_TOOLTIP = "Wait Switch 1 to be pressed";
/** @export */ Blockly.Msg.WAIT_SW1_PRESSED_HELPURL = "";
// wait sw1 released
/** @export */ Blockly.Msg.WAIT_SW1_RELEASED_TITLE = "Wait Switch 1 released";
/** @export */ Blockly.Msg.WAIT_SW1_RELEASED_TOOLTIP = "Wait Switch 1 to be released";
/** @export */ Blockly.Msg.WAIT_SW1_RELEASED_HELPURL = "";
// wait sw2 pressed
/** @export */ Blockly.Msg.WAIT_SW2_PRESSED_TITLE = "Wait Switch 2 pressed";
/** @export */ Blockly.Msg.WAIT_SW2_PRESSED_TOOLTIP = "Wait Switch 2 to be pressed";
/** @export */ Blockly.Msg.WAIT_SW2_PRESSED_HELPURL = "";
// wait sw2 released
/** @export */ Blockly.Msg.WAIT_SW2_RELEASED_TITLE = "Wait Switch 2 released";
/** @export */ Blockly.Msg.WAIT_SW2_RELEASED_TOOLTIP = "Wait Switch 2 to be released";
/** @export */ Blockly.Msg.WAIT_SW2_RELEASED_HELPURL = "";

// music blocks
// note
/** @export */ Blockly.Msg.MUSIC_NOTE_TITLE = "Note";
/** @export */ Blockly.Msg.MUSIC_NOTE_TOOLTIP = "Note";
/** @export */ Blockly.Msg.MUSIC_NOTE_HELPURL = "";
/** @export */ Blockly.Msg.MUSIC_NOTE_C4 = "C4";
/** @export */ Blockly.Msg.MUSIC_NOTE_CS4 = "C#4";
/** @export */ Blockly.Msg.MUSIC_NOTE_D4 = "D4";
/** @export */ Blockly.Msg.MUSIC_NOTE_EB4 = "Eb4";
/** @export */ Blockly.Msg.MUSIC_NOTE_E4 = "E4";
/** @export */ Blockly.Msg.MUSIC_NOTE_F4 = "F4";
/** @export */ Blockly.Msg.MUSIC_NOTE_FS4 = "F#4";
/** @export */ Blockly.Msg.MUSIC_NOTE_G4 = "G4";
/** @export */ Blockly.Msg.MUSIC_NOTE_GS4 = "G#4";
/** @export */ Blockly.Msg.MUSIC_NOTE_A4 = "A4";
/** @export */ Blockly.Msg.MUSIC_NOTE_BB4 = "Bb4";
/** @export */ Blockly.Msg.MUSIC_NOTE_B4 = "B4";
/** @export */ Blockly.Msg.MUSIC_NOTE_C5 = "C5";
/** @export */ Blockly.Msg.MUSIC_NOTE_CS5 = "C#5";
/** @export */ Blockly.Msg.MUSIC_NOTE_D5 = "D5";
/** @export */ Blockly.Msg.MUSIC_NOTE_EB5 = "Eb5";
/** @export */ Blockly.Msg.MUSIC_NOTE_E5 = "E5";
/** @export */ Blockly.Msg.MUSIC_NOTE_F5 = "F5";
/** @export */ Blockly.Msg.MUSIC_NOTE_FS5 = "F#5";
/** @export */ Blockly.Msg.MUSIC_NOTE_G5 = "G5";
/** @export */ Blockly.Msg.MUSIC_NOTE_GS5 = "G#5";
/** @export */ Blockly.Msg.MUSIC_NOTE_A5 = "A5";
/** @export */ Blockly.Msg.MUSIC_NOTE_BB5 = "Bb5";
/** @export */ Blockly.Msg.MUSIC_NOTE_B5 = "B5";
/** @export */ Blockly.Msg.MUSIC_NOTE_C6 = "C6";
/** @export */ Blockly.Msg.MUSIC_NOTE_CS6 = "C#6";
/** @export */ Blockly.Msg.MUSIC_NOTE_D6 = "D6";
/** @export */ Blockly.Msg.MUSIC_NOTE_EB6 = "Eb6";
/** @export */ Blockly.Msg.MUSIC_NOTE_E6 = "E6";
/** @export */ Blockly.Msg.MUSIC_NOTE_F6 = "F6";
/** @export */ Blockly.Msg.MUSIC_NOTE_FS6 = "F#6";
/** @export */ Blockly.Msg.MUSIC_NOTE_G6 = "G6";
/** @export */ Blockly.Msg.MUSIC_NOTE_GS6 = "G#6";
/** @export */ Blockly.Msg.MUSIC_NOTE_A6 = "A6";
/** @export */ Blockly.Msg.MUSIC_NOTE_BB6 = "Bb6";
/** @export */ Blockly.Msg.MUSIC_NOTE_B6 = "B6";
/** @export */ Blockly.Msg.MUSIC_NOTE_C7 = "C7";

/** @export */ Blockly.Msg.MUSIC_NOTE_DURATION = "Duration";
/** @export */ Blockly.Msg.MUSIC_NOTE_DURATION_WHOLE = "whole";
/** @export */ Blockly.Msg.MUSIC_NOTE_DURATION_HALF = "half";
/** @export */ Blockly.Msg.MUSIC_NOTE_DURATION_QUARTER = "quarter";
/** @export */ Blockly.Msg.MUSIC_NOTE_DURATION_EIGHTH = "eighth";
/** @export */ Blockly.Msg.MUSIC_NOTE_DURATION_SIXTEENTH = "sixteenth";
// rest
/** @export */ Blockly.Msg.MUSIC_REST_TITLE = "Rest";
/** @export */ Blockly.Msg.MUSIC_REST_TOOLTIP = "Rest";
/** @export */ Blockly.Msg.MUSIC_REST_HELPURL = "";
// scale
/** @export */ Blockly.Msg.MUSIC_SCALE_TITLE = "Scale";
/** @export */ Blockly.Msg.MUSIC_SCALE_CMAJ = "C Major";
/** @export */ Blockly.Msg.MUSIC_SCALE_CMIN = "C Minor";
/** @export */ Blockly.Msg.MUSIC_SCALE_CSMAJ = "C# Major";
/** @export */ Blockly.Msg.MUSIC_SCALE_CSMIN = "C# Minor";
/** @export */ Blockly.Msg.MUSIC_SCALE_DMAJ = "D Major";
/** @export */ Blockly.Msg.MUSIC_SCALE_DMIN = "D Minor";
/** @export */ Blockly.Msg.MUSIC_SCALE_EBMAJ = "Eb Major";
/** @export */ Blockly.Msg.MUSIC_SCALE_EBMIN = "Eb Minor";
/** @export */ Blockly.Msg.MUSIC_SCALE_EMAJ = "E Major";
/** @export */ Blockly.Msg.MUSIC_SCALE_EMIN = "E Minor";
/** @export */ Blockly.Msg.MUSIC_SCALE_FMAJ = "F Major";
/** @export */ Blockly.Msg.MUSIC_SCALE_FMIN = "F Minor";
/** @export */ Blockly.Msg.MUSIC_SCALE_FSMAJ = "F# Major";
/** @export */ Blockly.Msg.MUSIC_SCALE_FSMIN = "F# Minor";
/** @export */ Blockly.Msg.MUSIC_SCALE_GMAJ = "G Major";
/** @export */ Blockly.Msg.MUSIC_SCALE_GMIN = "G Minor";
/** @export */ Blockly.Msg.MUSIC_SCALE_GSMAJ = "G# Major";
/** @export */ Blockly.Msg.MUSIC_SCALE_GSMIN = "G# Minor";
/** @export */ Blockly.Msg.MUSIC_SCALE_AMAJ = "A Major";
/** @export */ Blockly.Msg.MUSIC_SCALE_AMIN = "A Minor";
/** @export */ Blockly.Msg.MUSIC_SCALE_BBMAJ = "Bb Major";
/** @export */ Blockly.Msg.MUSIC_SCALE_BBMIN = "Bb Minor";
/** @export */ Blockly.Msg.MUSIC_SCALE_BMAJ = "B Major";
/** @export */ Blockly.Msg.MUSIC_SCALE_BMIN = "B Minor";
/** @export */ Blockly.Msg.MUSIC_SCALE_TOOLTIP = "Music Scale";
/** @export */ Blockly.Msg.MUSIC_SCALE_HELPURL = "";
// music volume
/** @export */ Blockly.Msg.MUSIC_SET_VOLUME_TITLE = "Set Volume";
/** @export */ Blockly.Msg.MUSIC_SET_VOLUME_TOOLTIP = "Set Music Volume (0 to 100%)";
/** @export */ Blockly.Msg.MUSIC_SET_VOLUME_HELPURL = "";
/** @export */ Blockly.Msg.MUSIC_GET_VOLUME_TITLE = "Get Volume";
/** @export */ Blockly.Msg.MUSIC_GET_VOLUME_TOOLTIP = "Get Current Music Volume (0 to 100%)";
/** @export */ Blockly.Msg.MUSIC_GET_VOLUME_HELPURL = "";
// set tempo
/** @export */ Blockly.Msg.MUSIC_SET_TEMPO_TITLE = "Set Tempo";
/** @export */ Blockly.Msg.MUSIC_SET_TEMPO_TOOLTIP = "Set Tempo";
/** @export */ Blockly.Msg.MUSIC_SET_TEMPO_HELPURL = "";

// sensor blocks
// lm73
/** @export */ Blockly.Msg.SENSOR_LM73_TITLE = "Temperature Sensor";
/** @export */ Blockly.Msg.SENSOR_LM73_TOOLTIP = "Read Temperature";
/** @export */ Blockly.Msg.SENSOR_LM73_HELPURL = "";
// ldr
/** @export */ Blockly.Msg.SENSOR_LDR_TITLE = "Light Level Sensor";
/** @export */ Blockly.Msg.SENSOR_LDR_TOOLTIP = "Read Light Level";
/** @export */ Blockly.Msg.SENSOR_LDR_HELPURL = "";
// switch 1
/** @export */ Blockly.Msg.SENSOR_SWITCH1_TITLE = "Switch 1";
/** @export */ Blockly.Msg.SENSOR_SWITCH1_TOOLTIP = "Read Switch 1";
/** @export */ Blockly.Msg.SENSOR_SWITCH1_HELPURL = "";
// switch 2
/** @export */ Blockly.Msg.SENSOR_SWITCH2_TITLE = "Switch 2";
/** @export */ Blockly.Msg.SENSOR_SWITCH2_TOOLTIP = "Read Switch 2";
/** @export */ Blockly.Msg.SENSOR_SWITCH2_HELPURL = "";

// rtc blocks
// rtc get
/** @export */ Blockly.Msg.RTC_GET_TITLE = "Date/Time";
/** @export */ Blockly.Msg.RTC_GET_TOOLTIP = "Get Date/Time (string)";
/** @export */ Blockly.Msg.RTC_GET_HELPURL = "";
/** @export */ Blockly.Msg.RTC_GETDATE_TITLE = "Date";
/** @export */ Blockly.Msg.RTC_GETDATE_TOOLTIP = "Get Date (string)";
/** @export */ Blockly.Msg.RTC_GETDATE_HELPURL = "";
/** @export */ Blockly.Msg.RTC_GETTIME_TITLE = "Time";
/** @export */ Blockly.Msg.RTC_GETTIME_TOOLTIP = "Get Time (string)";
/** @export */ Blockly.Msg.RTC_GETTIME_HELPURL = "";
/** @export */ Blockly.Msg.RTC_GETYEAR_TITLE = "Year";
/** @export */ Blockly.Msg.RTC_GETYEAR_TOOLTIP = "Get Year (number)";
/** @export */ Blockly.Msg.RTC_GETYEAR_HELPURL = "";
/** @export */ Blockly.Msg.RTC_GETMONTH_TITLE = "Month";
/** @export */ Blockly.Msg.RTC_GETMONTH_TOOLTIP = "Get Month (number)";
/** @export */ Blockly.Msg.RTC_GETMONTH_HELPURL = "";
/** @export */ Blockly.Msg.RTC_GETDAY_TITLE = "Day";
/** @export */ Blockly.Msg.RTC_GETDAY_TOOLTIP = "Get Day Of Month (number)";
/** @export */ Blockly.Msg.RTC_GETDAY_HELPURL = "";
/** @export */ Blockly.Msg.RTC_GETHOUR_TITLE = "Hour";
/** @export */ Blockly.Msg.RTC_GETHOUR_TOOLTIP = "Get Hour (number)";
/** @export */ Blockly.Msg.RTC_GETHOUR_HELPURL = "";
/** @export */ Blockly.Msg.RTC_GETMINUTE_TITLE = "Minute";
/** @export */ Blockly.Msg.RTC_GETMINUTE_TOOLTIP = "Get Minute (number)";
/** @export */ Blockly.Msg.RTC_GETMINUTE_HELPURL = "";
/** @export */ Blockly.Msg.RTC_GETSECOND_TITLE = "Second";
/** @export */ Blockly.Msg.RTC_GETSECOND_TOOLTIP = "Get Second (number)";
/** @export */ Blockly.Msg.RTC_GETSECOND_HELPURL = "";
/** @export */ Blockly.Msg.RTC_CAL_TITLE = "RTC Trim";
/** @export */ Blockly.Msg.RTC_CAL_TOOLTIP = "set rtc digital trimming value (-127 to 127)";
/** @export */ Blockly.Msg.RTC_CAL_HELPURL = "";
/** @export */ Blockly.Msg.RTC_CAL_COARSE_TITLE = "RTC Trim Coarse";
/** @export */ Blockly.Msg.RTC_CAL_COARSE_TOOLTIP = "set rtc digital coarse trimming value (-127 to 127)";
/** @export */ Blockly.Msg.RTC_CAL_COARSE_HELPURL = "";

// I/O blocks
/** @export */ Blockly.Msg.STATUS = "Status";
/** @export */ Blockly.Msg.STATUS_OFF = "Off";
/** @export */ Blockly.Msg.STATUS_ON = "On";
/** @export */ Blockly.Msg.OUTPUT_WRITE_TITLE = "Write Output";
/** @export */ Blockly.Msg.OUTPUT_WRITE_TOOLTIP = "write output status";
/** @export */ Blockly.Msg.OUTPUT_WRITE_HELPURL = "";
/** @export */ Blockly.Msg.OUTPUT_READ_TITLE = "Read Output Status";
/** @export */ Blockly.Msg.OUTPUT_READ_TOOLTIP = "read output status";
/** @export */ Blockly.Msg.OUTPUT_READ_HELPURL = "";
/** @export */ Blockly.Msg.OUTPUT_TOGGLE_TITLE = "Toggle Output";
/** @export */ Blockly.Msg.OUTPUT_TOGGLE_TOOLTIP = "toggle output status";
/** @export */ Blockly.Msg.OUTPUT_TOGGLE_HELPURL = "";
/** @export */ Blockly.Msg.USBSW_WRITE_TITLE = "Write USB";
/** @export */ Blockly.Msg.USBSW_WRITE_STATUS = "Status";
/** @export */ Blockly.Msg.USBSW_WRITE_TOOLTIP = "write usb status";
/** @export */ Blockly.Msg.USBSW_WRITE_HELPURL = "";
/** @export */ Blockly.Msg.USBSW_READ_TITLE = "Read USB Status";
/** @export */ Blockly.Msg.USBSW_READ_TOOLTIP = "read usb status";
/** @export */ Blockly.Msg.USBSW_READ_HELPURL = "";
/** @export */ Blockly.Msg.USBSW_TOGGLE_TITLE = "Toggle USB Status";
/** @export */ Blockly.Msg.USBSW_TOGGLE_TOOLTIP = "toggle USB status";
/** @export */ Blockly.Msg.USBSW_TOGGLE_HELPURL = "";
/** @export */ Blockly.Msg.INPUT_READ_TITLE = "Read Input Status";
/** @export */ Blockly.Msg.INPUT_READ_TOOLTIP = "read input status";
/** @export */ Blockly.Msg.INPUT_READ_HELPURL = "";

// advance blocks
// task
/** @export */ Blockly.Msg.ADVANCE_TASK_TITLE = "Task";
/** @export */ Blockly.Msg.ADVANCE_TASK_TOOLTIP = "Task";
/** @export */ Blockly.Msg.ADVANCE_TASK_HELPURL = "";
// current drain
/** @export */ Blockly.Msg.ADVANCE_CURRENT_DRAIN_WRITE_TITLE = "PowerBank Current Drain";
/** @export */ Blockly.Msg.ADVANCE_CURRENT_DRAIN_TOOLTIP = "Set current drain to On to protect powerbank auto power off";
/** @export */ Blockly.Msg.ADVANCE_CURRENT_DRAIN_HELPURL = "";

// menu
/** @export */ Blockly.Msg.BUTTON_RUN = "Run";
/** @export */ Blockly.Msg.BUTTON_SAVE = "Save";
/** @export */ Blockly.Msg.BUTTON_OPEN = "Open";

// category
/** @export */ Blockly.Msg.CATEGORY_BASIC = "Basic";
/** @export */ Blockly.Msg.CATEGORY_WAIT = "Wait";
/** @export */ Blockly.Msg.CATEGORY_MATH = "Math";
/** @export */ Blockly.Msg.CATEGORY_LOGIC = "Logic";
/** @export */ Blockly.Msg.CATEGORY_LOOP = "Loop";
/** @export */ Blockly.Msg.CATEGORY_MUSIC = "Music";
/** @export */ Blockly.Msg.CATEGORY_SENSOR = "Sensor";
/** @export */ Blockly.Msg.CATEGORY_RTC = "Date/Time";
/** @export */ Blockly.Msg.CATEGORY_IO = "I/O";
/** @export */ Blockly.Msg.CATEGORY_ADVANCE = "Advance";

/** @export */ Blockly.Msg.INPUT = "Input";
/** @export */ Blockly.Msg.OUTPUT = "Output";
/** @export */ Blockly.Msg.CHANNEL = "Channel";
/** @export */ Blockly.Msg.ADDRESS = "Address";

// publish gauge_iot blocks
/** @export */ Blockly.Msg.GAUGE_IOT_TITLE = "Send data to";
/** @export */ Blockly.Msg.GAUGE_IOT_TOOLTIP = "Get data then publish to Gauge IOT";
/** @export */ Blockly.Msg.GAUGE_IOT_HELPURL = "";

// config gauge title
/** @export */ Blockly.Msg.MESSAGE_TO = "to";
...
/** @export */ Blockly.Msg.GAUGE_UNIT_TOOLTIP = "Send data to config gauge unit";
/** @export */ Blockly.Msg.GAUGE_UNIT_HELPURL = "";

// config gauge color
/** @export */ Blockly.Msg.GAUGE_COLOR_TITLE = "Config color";
/** @export */ Blockly.Msg.GAUGE_COLOR_TOOLTIP = "Send data to config gauge color";
/** @export */ Blockly.Msg.GAUGE_COLOR_HELPURL = "";

// publish gauge min max blocks
/** @export */ Blockly.Msg.GAUGE_MINMAX_TITLE = "Config max value of";
/** @export */ Blockly.Msg.GAUGE_MIN_TITLE = "Min :";
/** @export */ Blockly.Msg.GAUGE_MAX_TITLE = "Max :";
/** @export */ Blockly.Msg.GAUGE_MINMAX_TOOLTIP = "Send data to config minimum and maximum value of gauge";
/** @export */ Blockly.Msg.GAUGE_MINMAX_HELPURL = "";

// publish feed_iot blocks
/** @export */ Blockly.Msg.FEED_IOT_TITLE = "Send data to";
/** @export */ Blockly.Msg.FEED_IOT_TOOLTIP = "Get data then publish to graph IOT";
/** @export */ Blockly.Msg.FEED_IOT_HELPURL = "";

// config feed title
/** @export */ Blockly.Msg.FEED_TITLE_TITLE = "Config title ";
/** @export */ Blockly.Msg.FEED_TITLE_TOOLTIP = "Send data to config field title";
/** @export */ Blockly.Msg.FEED_TITLE_HELPURL = "";

// config feed main title
/** @export */ Blockly.Msg.FEED_MAIN_TITLE = "Config graph title ";
/** @export */ Blockly.Msg.FEED_MAIN_TITLE_TOOLTIP = "Send data to config graph title";
/** @export */ Blockly.Msg.FEED_MAIN_TITLE_HELPURL = "";
/** @export */ Blockly.Msg.FIELD1 = "Graph1";
/** @export */ Blockly.Msg.FIELD2 = "Graph2";
/** @export */ Blockly.Msg.FIELD3 = "Graph3";
/** @export */ Blockly.Msg.FIELD4 = "Graph4";
/** @export */ Blockly.Msg.FIELD5 = "Graph5";
/** @export */ Blockly.Msg.FIELD6 = "Graph6";
/** @export */ Blockly.Msg.FIELD7 = "Graph7";
/** @export */ Blockly.Msg.FIELD8 = "Graph8";
/** @export */ Blockly.Msg.FIELD9 = "Graph9";

// config feed unit
/** @export */ Blockly.Msg.FEED_UNIT_TITLE = "Config unit";
/** @export */ Blockly.Msg.FEED_UNIT_TOOLTIP = "Send data to config field unit";
/** @export */ Blockly.Msg.FEED_UNIT_HELPURL = "";

// config feed color
/** @export */ Blockly.Msg.FEED_COLOR_TITLE = "Config color";
/** @export */ Blockly.Msg.FEED_COLOR_TOOLTIP = "Send data to config field color";
/** @export */ Blockly.Msg.FEED_COLOR_HELPURL = "";

// publish feed min max blocks
/** @export */ Blockly.Msg.FEED_MINMAX_TITLE = "Config min/max value of";
/** @export */ Blockly.Msg.FEED_MIN_TITLE = "Min :";
/** @export */ Blockly.Msg.FEED_MAX_TITLE = "Max :";
/** @export */ Blockly.Msg.FEED_MINMAX_TOOLTIP = "Send data to config minimum and maximum value of field";
/** @export */ Blockly.Msg.FEED_MINMAX_HELPURL = "";

// math pow additional
/** @export */ Blockly.Msg.MATH_POW_TITLE = "^";
/** @export */ Blockly.Msg.MATH_POW_TOOLTIP = "math pow";
/** @export */ Blockly.Msg.MATH_POW_HELPURL = "";

// push notification
/** @export */ Blockly.Msg.PUSH_NOTIFICATION_TITLE = "push notification  topic:";
/** @export */ Blockly.Msg.PUSH_NOTIFICATION_MSG = " message: ";
/** @export */ Blockly.Msg.PUSH_NOTIFICATION_TOOLTIP = "Set topic and send message to kidbright IOT app.";
/** @export */ Blockly.Msg.PUSH_NOTIFICATION_HELPURL = "";

// mqtt setting
/** @export */ Blockly.Msg.MQTT_SET_CLIENT_ID = "client id";
/** @export */ Blockly.Msg.MQTT_SERVER = "server";
/** @export */ Blockly.Msg.MQTT_PORT = "port";
/** @export */ Blockly.Msg.MQTT_USER = "user";
/** @export */ Blockly.Msg.MQTT_PASSWORD = "password";
/** @export */ Blockly.Msg.MQTT_KEEP_ALIVE = "keep alive";
/** @export */ Blockly.Msg.MQTT_SET_TOOLTIP = "config setting mqtt";

// mqtt subscribe
/** @export */ Blockly.Msg.MQTT_SUBSCRIBE = "subscribe with topic ";
/** @export */ Blockly.Msg.MQTT_SUBSCRIBE_TOOLTIP = "subscribe task";

// mqtt publish
/** @export */ Blockly.Msg.MQTT_PUBLISH_INIT = "publish data ";
/** @export */ Blockly.Msg.MQTT_PUBLISH_TOPIC = "to topic";
/** @export */ Blockly.Msg.MQTT_PUBLISH_TOOLTOP = "publish data to topic";

// mqtt start
/** @export */ Blockly.Msg.MQTT_START = "mqtt start";
/** @export */ Blockly.Msg.MQTT_START_TOOLTIP = "start working with mqtt protocal";

// mqtt get topic data
/** @export */ Blockly.Msg.MQTT_GET_TOPIC_DATA = "get topic data";
/** @export */ Blockly.Msg.MQTT_GET_TOPIC_DATA_TOOLTIP = "get topic data";

// function
/** @export */ Blockly.Msg.FUNCTION_TITLE = "Function";
/** @export */ Blockly.Msg.CALL_FUNCTION_TITLE = "Call function";

// string
/** @export */ Blockly.Msg.JOIN_STRING_CREATE_WITH_INPUT_WITH = "Join string with";
/** @export */ Blockly.Msg.JOIN_STRING_CREATE_WITH_TOOLTIP = "Join string from text, variable, and sensor. Maximum 100 characters";

/** @export */ Blockly.Msg.STRING_LENGTH_MESSAGE = "Length of text";
/** @export */ Blockly.Msg.STRING_LENGTH_TOOLTIP = "get length of text.";

/** @export */ Blockly.Msg.STRING_SUBSTRING_TEXT = "Substring";
/** @export */ Blockly.Msg.STRING_SUBSTRING_FROM = "from";
/** @export */ Blockly.Msg.STRING_SUBSTRING_TO = "to";
/** @export */ Blockly.Msg.STRING_SUBSTRING_TOOLTIP = "Split text from text by set index.";

/** @export */ Blockly.Msg.STRING_CHAR_AT_TEXT = "Get character from ";
/** @export */ Blockly.Msg.STRING_CHAR_AT_INDEX = "at";
/** @export */ Blockly.Msg.STRTING_CHAT_AT_TOOLTIP = "Return character from text by set index.";

/** @export */ Blockly.Msg.STRING_WITH_NUMBER = "Join text ";
/** @export */ Blockly.Msg.STRING_WITH_NUMBER_VALUE = "with number";
/** @export */ Blockly.Msg.STRING_WITH_NUMBER_TOOLTIP = "Merge text with number or sensor value. For example, \"Current temperature is 35\".";

// list
/** @export */ Blockly.Msg.LIST_GET_LENGTH = "Get length of the list";
/** @export */ Blockly.Msg.LIST_GET_LENGTH_TOOLTIP = "Return the number of value(s) inside an array";

/** @export */ Blockly.Msg.LIST_GET_INDEX = "Get value at index";
/** @export */ Blockly.Msg.LIST_GET_INDEX_TOOLTIP = "Return the value at specified index";

/** @export */ Blockly.Msg.LIST_SET_INDEX_VALUE = "Set value to";
/** @export */ Blockly.Msg.LIST_SET_INDEX_AT  = "at index";
/** @export */ Blockly.Msg.LIST_SET_INDEX_TOOLTIP = "Change the value at specified index";

/** @export */ Blockly.Msg.LIST_INSERT_LAST = "Append value %1 into the list";
/** @export */ Blockly.Msg.LIST_INSERT_LAST_TOOLTIP = "Insert value to the last index of list. For example, if insert 5 in list [1, 2, 3] using this function, the list will be changed to [1, 2, 3, 5]";

/** @export */ Blockly.Msg.LIST_INSERT_FIRST = "Append value %1 at the beginning of the list";
/** @export */ Blockly.Msg.LIST_INSERT_FIRST_TOOLTIP = "Insert value to the first index of list. For example, if insert 5 in list [1, 2, 3] using this fucntion, the list will be changed to [5, 1, 2, 3] ";

/** @export */ Blockly.Msg.LIST_INSERT_INDEX_VALUE = "Append value";
/** @export */ Blockly.Msg.LIST_INSERT_INDEX_AT = "into the list at index";
/** @export */ Blockly.Msg.LIST_INSERT_INDEX_TOOLTIP = "Insert value to list at the specified index";

/** @export */ Blockly.Msg.LIST_GET_TEXT = "Read value in list from %1 to %2";
/** @export */ Blockly.Msg.LIST_GET_TEXT_TOOLTIP = "specify start and end index to show value from the list.";

// Number to srring
Blockly.Msg.tostring_TEXT_TITLE   = "number to strings";
Blockly.Msg.tostring_TEXT_TOOLTIP = "number to strings TOOLTIP";
Blockly.Msg.tostring_TEXT_HELPURL = "number to strings HELPURL";

// Special IO
Blockly.Msg.SPEC_IOS_ANALOG_TITLE = "Read Analog Channel:";
Blockly.Msg.SPEC_IOS_ANALOG_TOOLTIP = "Read raw data from the selected analog channel";
Blockly.Msg.SPEC_IOS_ANALOG_HELPURL = "";

Blockly.Msg.SPEC_IOS_OUTPUT_TITLE = "Write Digital Output:";
Blockly.Msg.SPEC_IOS_OUTPUT_TOOLTIP = "Write On or Off to the selected digital output";
Blockly.Msg.SPEC_IOS_OUTPUT_HELPURL = "";
...
// ESP Now
Blockly.Msg.ESPNOW_GET_MAC_MESSAGE = "ESP-NOW get my mac address";
Blockly.Msg.ESPNOW_GET_MAC_TOOLTIP = "Get my KidBright MAC Address";

Blockly.Msg.ESPNOW_SEND_MESSAGE = "ESP-NOW send %1";
Blockly.Msg.ESPNOW_SEND_TOOLTIP = "Send data between KidBright32 via ESP-NOW";

Blockly.Msg.ESPNOW_SEND2_MESSAGE = "ESP-NOW send %1 to %2";
Blockly.Msg.ESPNOW_SEND2_TOOLTIP = "Send data to once KidBright32 via ESP-NOW";

Blockly.Msg.ESPNOW_RECV_MESSAGE = "ESP-NOW on receiving %1 %2";
Blockly.Msg.ESPNOW_RECV_TOOLTIP = "Do in this block when receiving from other KidBright32 via ESP-NOW";

Blockly.Msg.ESPNOW_READ_STRING_MESSAGE = "ESP-NOW read text";
Blockly.Msg.ESPNOW_READ_STRING_TOOLTIP = "Read text from other KidBright32 via ESP-NOW";

Blockly.Msg.ESPNOW_READ_NUMBER_MESSAGE = "ESP-NOW read number";
Blockly.Msg.ESPNOW_READ_NUMBER_TOOLTIP = "Read number from other KidBright32 via ESP-NOW";
...
//Line
Blockly.Msg.LINENOTIFY_SET_ACCESS_TOKEN_MESSAGE = "Set Access Token to";

Blockly.Msg.LINENOTIFY_SEND_NOTIFICATIONS_MESSAGE = "%1 Sends notifications %2 Message %3 Image thumbnail %4 Image full size %5 Sticker Package Id %6 Sticker Id %7";
Blockly.Msg.LINENOTIFY_SEND_NOTIFICATIONS_TOOLTIP = "Sends notifications to users or groups that are related to an access token";

//Bluetooth
Blockly.Msg.BT_SETUP = "Setup bluetooth name";
Blockly.Msg.BT_ON_AUTH = "Bluetooth on authentication";
Blockly.Msg.BT_GET_PASS = "Bluetooth get password";
